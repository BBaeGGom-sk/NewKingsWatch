...
<!-- ---------------------------메인---------------------------- -->
	<section class="home-slider owl-carousel">
		...
		<div class="slider-item"	style="background-image: url('/resources/images/watch8.jpg');">	<!-- 갈남색 -->
		...
		<div class="slider-item" style="background-image: url(/resources/images/watch7.jpg);"> <!-- 커피컵 -->
			<div class="overlay"></div>
			<div class="container">
				<div
		...
		<div class="slider-item"
			style="background-image: url(/resources/images/watch6.jpg);">	
			<div class="overlay"></div>
			<div class="container">
				<div
					class="row slider-text justify-content-center align-items-center"
    ...
    <section class="ftco-about d-md-flex">
    	<div class="one-half img" style="background-image: url(/resources/images/watch1.jpg);"></div>
		...
		<div class="container">
			<div class="row justify-content-center mb-5 pb-3">
				<div class="col-md-7 heading-section ftco-animate text-center">
					<span class="subheading">King's</span>
					<h2 class="mb-4">Best Sellers</h2>
					<p> 킹스 워치에서 가장 잘팔리는 4개의 상품입니다.</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3">
						...
						<div class="col-md-12 nav-link-wrap mb-5">
							<div class="nav ftco-animate nav-pills justify-content-center"
								...
								<a class="nav-link active" id="v-pills-1-tab" data-toggle="pill"
									...
									aria-selected="true">Main Dish</a> <a class="nav-link"
        ...
        <div class="row">
        	<div class="col-md-6 mb-5 pb-3">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(resources/images/dish-1.jpg);"></div>
        			<div class="desc pl-3">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(resources/images/dish-2.jpg);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(resources/images/dish-3.jpg);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(/resources/images/dish-4.jpg);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
        	...
        	<div class="col-md-6 mb-5 pb-3">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(/resources/images/dish-5.jpg);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(/resources/images/dish-6.jpg);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(/resources/images/dish-7.jpg);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(/resources/images/dish-8.jpg);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
...
<!-- ----------------물건 리스트부분. 사진, 올린날짜, 올린사람, 댓글수, 타이틀, 콘텐츠------------------ -->
    <section class="ftco-section">
      <div class="container">
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="/resources/images/menu-2.jpg" class="image-popup"><img src="/resources/images/menu-2.jpg" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				<h3>Creamy Latte Coffee</h3>
    				<p class="price"><span>$4.90</span></p>
    				<p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
    				<p>On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its origin would be the word "and" and the Little Blind Text should turn around and return to its own, safe country. But nothing the copy said could convince her and so it didn?셳 take long until a few insidious Copy Writers ambushed her, made her drunk with Longe and Parole and dragged her into their agency, where they abused her for their.
						</p>
						<div class="row mt-4">
							<div class="col-md-6">
	    				...
	    				<table class="table">
						    ...
						    <tbody>
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(/resources/images/menu-2.jpg);"></div></td>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(/resources/images/dish-2.jpg);"></div></td>
