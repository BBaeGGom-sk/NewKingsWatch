	...
	<div class="conP mContain">
        <ul class="bbList watch watch3Layout">
	        	...
	        	<div style="display: inline-block; float: right; margin-bottom: auto;">
					<a href="/goods/goodsSearch" class="href_tag"><span class="spanAlign">NEW</span></a>
					<a href="/goods/rowPriceGoodsSearch" class="href_tag"><span class="spanAlign">ROW PRICE</span></a>
					<a href="/goods/highPriceGoodsSearch" class="href_tag"><span class="spanAlign">HIGH PRICE</span></a>
		        </div>
			<hr>
			<c:if test="${searchGoodsList ne null}">
