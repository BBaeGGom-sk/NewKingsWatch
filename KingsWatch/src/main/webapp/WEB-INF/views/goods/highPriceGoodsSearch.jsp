	...
	<section id="content">
	 ...
	 <hr>
	  <div id="container_box">
		 ...
		 <ul>
		 	<c:forEach items="${highPriceGoodsSearch}" var="list"  varStatus="status">
			 	<li>
	 ...
	 <div class="row text-center">
		<ul class="pagination">
			<c:if test="${pm.cri.page>1}">
				<li><a href="/goods/highPriceGoodsSearch${pm.makeSearch(pm.cri.page-1)}">&laquo;</a></li>
			</c:if>
				...
				<c:if test="${pm.cri.page<pm.totalPage}">
					<li><a href="/goods/highPriceGoodsSearch${pm.makeSearch(pm.cri.page+1)}">&raquo;</a></li>
				</c:if>
			</ul>
		</div>
