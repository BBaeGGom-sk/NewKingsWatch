	  ...
	  <div class="row">
			<div class="conP mContain">
				<ul class="bbList watch watch3Layout">
					...
					<div style="display: inline-block; clear:both; float: right; margin-bottom: auto;">
						<a href="/goods/goodsList"><span class="spanAlign">NEW</span></a>
						<a href="/goods/rowPriceGoods"><span class="spanAlign">ROW
								PRICE</span></a> <a href="/goods/highPriceGoods"><span
