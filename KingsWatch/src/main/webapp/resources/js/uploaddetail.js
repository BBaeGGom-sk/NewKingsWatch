...
function getFileInfo2(data) { // data= 썸네일에 대한 주소
	...
	if(checkImageType(data)){ // 이미지파일이면
		...
		getLink="/displaydetailfile?fileName="+data;
